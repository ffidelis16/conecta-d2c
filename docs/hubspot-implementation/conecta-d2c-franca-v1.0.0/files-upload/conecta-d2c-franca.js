/* Conecta D2C Franca · formulário e tracking · v1.0.0 */
(function conectaD2C() {
  "use strict";
...
document.addEventListener("DOMContentLoaded", () => {
      const modal = document.querySelector("[data-form-modal]");
      document.querySelectorAll('[data-open-form="event_pre_registration"]').forEach((button) => {
        button.addEventListener("click", () => {
          modal.querySelector("[data-form-modal-eyebrow]").textContent = "PRÉ-INSCRIÇÃO";
          modal.querySelector("[data-form-modal-title]").textContent = "Fazer pré-inscrição";
          modal.querySelector("[data-form-modal-description]").textContent = "A pré-inscrição não confirma a participação. A equipe organizadora avaliará os dados enviados e entrará em contato com as próximas orientações.";
        });
      });
    });
